...
- The proof boundary is explicit in `docs/eval/startup-diligence-war-room-live.json`: live shell proof and deterministic UI proof are in hand; live provider CellPayload/runway/proposal evidence remains the production gate.
