...
- The proof boundary is explicit in `docs/eval/startup-diligence-war-room-live.json`: live shell proof, deterministic UI proof, and the Convex contract eval are in hand; provider-produced CellPayload/final-copy evidence remains the production gate.
