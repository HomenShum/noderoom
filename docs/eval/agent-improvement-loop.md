...
Generated: 2026-06-13T12:09:20.435Z
...
Latest run artifact: `docs/eval/agent-improvement-loop/20260613T120851Z.json`

Summary: 23 pass, 0 fail, 8 skip.
...
| BankerToolBench staged runner fixture | deterministic | PASS | 2.0s | `npx vitest run tests/bankerToolBenchRunner.test.ts` |
...
| SpreadsheetBench staged runner fixture | deterministic | PASS | 3.4s | `npx vitest run tests/spreadsheetBenchRunner.test.ts` |
