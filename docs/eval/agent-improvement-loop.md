...
Generated: 2026-06-13T12:41:49.250Z
...
Latest run artifact: `docs/eval/agent-improvement-loop/20260613T124117Z.json`

Summary: 27 pass, 0 fail, 8 skip.
...
| BankerToolBench staged runner fixture | deterministic | PASS | 1.8s | `npx vitest run tests/bankerToolBenchRunner.test.ts` |
...
| SpreadsheetBench staged runner fixture | deterministic | PASS | 3.1s | `npx vitest run tests/spreadsheetBenchRunner.test.ts` |
