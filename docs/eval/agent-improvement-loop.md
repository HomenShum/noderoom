...
Generated: 2026-06-13T15:08:13.311Z
...
Latest run artifact: `docs/eval/agent-improvement-loop/20260613T150731Z.json`
...
| SpreadsheetBench staged runner fixture | deterministic | PASS | 3.8s | `npx vitest run tests/spreadsheetBenchRunner.test.ts` |
...
| Docker/Harbor availability probe | deterministic | BLOCKED | 1.0s | `npm run benchmark:docker-sandbox:probe -- --require-pass` |
