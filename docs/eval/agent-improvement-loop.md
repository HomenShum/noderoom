...
Generated: 2026-06-13T15:10:44.152Z
...
Latest run artifact: `docs/eval/agent-improvement-loop/20260613T151002Z.json`
...
| BankerToolBench sandbox stage fixture | deterministic | PASS | 1.8s | `npx vitest run tests/bankerToolBenchStage.test.ts` |
...
| SpreadsheetBench official ingest fixture | deterministic | PASS | 1.8s | `npx vitest run tests/spreadsheetBenchAdapter.test.ts` |
