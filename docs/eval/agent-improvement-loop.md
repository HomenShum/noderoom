...
Generated: 2026-06-13T14:15:21.872Z
...
Latest run artifact: `docs/eval/agent-improvement-loop/20260613T141446Z.json`

Summary: 28 pass, 0 fail, 8 skip.
...
| SpreadsheetBench chart package score fixture | deterministic | PASS | 1.8s | `npx vitest run tests/spreadsheetBenchChartScorer.test.ts` |
