...
Generated: 2026-06-13T11:09:20.070Z
...
Latest run artifact: `docs/eval/agent-improvement-loop/20260613T110851Z.json`

Summary: 20 pass, 0 fail, 8 skip.
...
| BankerToolBench official ingest fixture | deterministic | PASS | 2.0s | `npx vitest run tests/bankerToolBenchAdapter.test.ts` |
...
| SpreadsheetBench workbook score fixture | deterministic | PASS | 2.2s | `npx vitest run tests/spreadsheetBenchScorer.test.ts` |
