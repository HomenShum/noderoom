...
Generated: 2026-06-13T15:24:48.136Z
...
Latest run artifact: `docs/eval/agent-improvement-loop/20260613T152407Z.json`
...
| BankerToolBench staged runner fixture | deterministic | PASS | 2.3s | `npx vitest run tests/bankerToolBenchRunner.test.ts` |
...
| SpreadsheetBench workbook score fixture | deterministic | PASS | 2.7s | `npx vitest run tests/spreadsheetBenchScorer.test.ts` |
